...
class VidSituDataset(object):
    ...
    def getanno(self, annotation):
        ...
        vid_feat = get_vid_embeddings(annotation['vid_path'], annotation['event'])
        if vid_feat is None:
            return None
...
dataset = VidSituDataset(split='valid')
pkl_dir = '/data/dataset/VidSitu/data/clip_feat_xtf_vit-b32'
annos = []
